...
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    "VHS_LoadVideoPath": "Load Video (URL & Path) 🎥🅥🅗🅢",
    "VHS_LoadVideoFFmpeg": "Load Video FFmpeg (Upload) 🎥🅥🅗🅢",
    "VHS_LoadVideoFFmpegPath": "Load Video FFmpeg (Path & URL) 🎥🅥🅗🅢",
    "VHS_LoadImagePath": "Load Image (URL & Path) 🎥🅥🅗🅢",
    "VHS_LoadImages": "Load Images (Upload) 🎥🅥🅗🅢",
    "VHS_LoadImagesPath": "Load Images (URL & Path) 🎥🅥🅗🅢",
    "VHS_LoadAudio": "Load Audio (Path & URL) 🎥🅥🅗🅢",
